# Telegram-channel-messages-analyzer
A free GUI tool to extract the full list of messages information and details from all Telegram channels and groups.

---

## ✨ Features
- Accounts login & management
- Extract messages by channel link/username/channel id
- Live status & logs UI
